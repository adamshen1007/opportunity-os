...
export const optionalEnvironmentSchema = z.object({
  ...
  OPPORTUNITY_OS_WEB_ORIGINS: nonEmptyStringSchema.optional(),
  ...
  API_AUTH_REQUIRED: booleanStringSchema.optional(),
  API_ADMIN_ACCESS_TOKEN: nonEmptyStringSchema.optional(),
  AUTH_SECRET_PEPPER: nonEmptyStringSchema.optional(),
  AUTH_INVITE_TTL_MS: z.coerce.number().int().min(1).optional(),
  AUTH_SESSION_TTL_MS: z.coerce.number().int().min(1).optional(),
