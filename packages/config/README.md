...
- hosted external MVP runtime: `OPPORTUNITY_OS_API_URL`, `OPPORTUNITY_OS_WEB_URL`, `NEXT_PUBLIC_OPPORTUNITY_OS_API_BASE_URL`, `LLM_PROVIDER`, `LLM_MODEL`, `LLM_LIVE_ANALYSIS_ENABLED`, `LLM_PROVIDER_TIMEOUT_MS`
